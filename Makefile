...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Jun 8 03:34:06 2010
...
SOURCES       = glwidget.cpp \
		...
		being.cpp \
		lucidbeaver.cpp \
		globalcontainer.cpp moc_glwidget.cpp \
		moc_paintwidget.cpp \
		moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.h paintwidget.h mainwindow.h welcomewindow.h field.h vector.h vector2.h world.h texture.h object.h node.h md2.h hero.h error.h engine.h clock.h camera.h being.h lucidbeaver.h globalcontainer.h .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.cpp paintwidget.cpp mainwindow.cpp main.cpp welcomewindow.cpp field.cpp world.cpp texture.cpp object.cpp node.cpp md2.cpp hero.cpp error.cpp engine.cpp clock.cpp camera.cpp being.cpp lucidbeaver.cpp globalcontainer.cpp .tmp/lucidBeaver1.0.0/ && (cd `dirname .tmp/lucidBeaver1.0.0` && $(TAR) lucidBeaver1.0.0.tar lucidBeaver1.0.0 && $(COMPRESS) lucidBeaver1.0.0.tar) && $(MOVE) `dirname .tmp/lucidBeaver1.0.0`/lucidBeaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lucidBeaver1.0.0
