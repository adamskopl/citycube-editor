...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Jun 22 23:57:25 2010
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.h paintwidget.h mainwindow.h welcomewindow.h field.h vector.h vector2.h world.h texture.h object.h node.h md2.h hero.h error.h engine.h clock.h camera.h being.h lucidbeaver.h globalcontainer.h floor.h lbstairs.h .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.cpp paintwidget.cpp mainwindow.cpp main.cpp welcomewindow.cpp field.cpp world.cpp texture.cpp object.cpp node.cpp md2.cpp hero.cpp error.cpp engine.cpp clock.cpp camera.cpp being.cpp lucidbeaver.cpp globalcontainer.cpp floor.cpp lbstairs.cpp .tmp/lucidBeaver1.0.0/ && (cd `dirname .tmp/lucidBeaver1.0.0` && $(TAR) lucidBeaver1.0.0.tar lucidBeaver1.0.0 && $(COMPRESS) lucidBeaver1.0.0.tar) && $(MOVE) `dirname .tmp/lucidBeaver1.0.0`/lucidBeaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lucidBeaver1.0.0
...
moc_welcomewindow.cpp: welcomewindow.h
	/usr/bin/moc $(DEFINES) $(INCPATH) welcomewindow.h -o moc_welcomewindow.cpp
