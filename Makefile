...
# Generated by qmake (2.01a) (Qt 4.6.2) on: czw. gru 23 21:38:48 2010
# Project:  lucidBeaver.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile lucidBeaver.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/X11R6/lib `sdl-config --libs --cflags` -lSDL -lSDL_image -I/usr/X11R6/include -L/usr/X11R6/lib -lmxml -lQtOpenGL -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = glwidget.cpp \
		...
		lbxmlmanager.cpp moc_glwidget.cpp \
		moc_paintwidget.cpp \
		moc_mainwindow.cpp \
...
Makefile: lucidBeaver.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile lucidBeaver.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.h paintwidget.h mainwindow.h welcomewindow.h field.h vector.h world.h texture.h object.h node.h md2.h hero.h error.h engine.h clock.h camera.h being.h lucidbeaver.h globalcontainer.h floor.h lbstairs.h lbpassage.h lbwallhelper.h lbmathhelper.h counter.h lbstairshelper.h lbhelpersbase.h lbwindow.h designwidgetmini.h lbxmlmanager.h .tmp/lucidBeaver1.0.0/ && $(COPY_FILE) --parents glwidget.cpp paintwidget.cpp mainwindow.cpp main.cpp welcomewindow.cpp field.cpp world.cpp texture.cpp object.cpp node.cpp md2.cpp hero.cpp error.cpp engine.cpp clock.cpp camera.cpp being.cpp lucidbeaver.cpp globalcontainer.cpp floor.cpp lbstairs.cpp lbpassage.cpp lbwallhelper.cpp lbmathhelper.cpp lbstairshelper.cpp lbhelpersbase.cpp lbwindow.cpp designwidgetmini.cpp lbxmlmanager.cpp .tmp/lucidBeaver1.0.0/ && (cd `dirname .tmp/lucidBeaver1.0.0` && $(TAR) lucidBeaver1.0.0.tar lucidBeaver1.0.0 && $(COMPRESS) lucidBeaver1.0.0.tar) && $(MOVE) `dirname .tmp/lucidBeaver1.0.0`/lucidBeaver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lucidBeaver1.0.0
...
lbxmlmanager.o: lbxmlmanager.cpp lbxmlmanager.h \
		globalcontainer.h \
		object.h \
		camera.h \
		vector.h \
		...
		lbmathhelper.h \
		floor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lbxmlmanager.o lbxmlmanager.cpp
