...
# Generated by qmake (2.01a) (Qt 4.6.2) on: pt. lis 19 16:19:44 2010
...
CXXFLAGS      = -g -pipe -O2 -Wall -Wno-ignored-qualifiers -W -D_REENTRANT $(DEFINES)
...
SOURCES       = glwidget.cpp \
		...
		lbpassage.cpp \
		lbwallhelper.cpp \
		lbmathhelper.cpp moc_glwidget.cpp \
		moc_paintwidget.cpp \
		moc_mainwindow.cpp \
